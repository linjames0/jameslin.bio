    ...
    <html>
        ...
        <body className={styles.body}>
            ...
            <div className={styles.mainBox}>
                <h1 className={styles.postTitle}>Smart people are often strange</h1>
                <h3 className={styles.postDate}>October 25th, 2022</h3>
